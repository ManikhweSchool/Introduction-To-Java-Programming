...
public class Exercise_6_15b {
	...
	public static void main(String[] args) {
		...
		double taxableIncome = Math.random()*1000000;
		
		System.out.printf("Taxable Income : %f\tTax : %5.1f\tStatus : %d" 
		, taxableIncome,computeTax(status, taxableIncome), status);
		...
		// Compute tax
				...
				if(status == 0) {
					...
					if(income <= 16700)
						...
						tax = 16700*0.10 + (67900-16700)*0.25 +
					...
					if(income <= 11950)
						...
						tax = 11950*0.10 + (45500-11950)*0.25 +
